...
export const HomeScreen = ({ onStart, bestScore, isSoundOn, toggleSound }: HomeScreenProps) => {
    ...
    return (
        // h-[100dvh] を使い、モバイルブラウザのアドレスバー考慮の高さを確保
        <div className="flex flex-col items-center w-full h-[100dvh] z-10 relative overflow-hidden">

            {/* Control Buttons: 絶対配置をやめ、ヘッダーとして配置 */}
            <div className="w-full flex justify-end gap-4 p-4 pt-[calc(16px+env(safe-area-inset-top))] z-50">
                <button
                    onClick={toggleSound}
            ...
            {/* Main Content: 残りのスペースの中央に配置 */}
            <div className="flex-1 flex flex-col items-center justify-center gap-12 w-full pb-20">
